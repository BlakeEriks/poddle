    ...
    return (
        <div className="flex flex-col">
            <div className="relative flex flex-row items-center space-evenly py-28">
                ...
                <div className="w-3/5">
                    <img src="https://i.imgur.com/6XzrvsG.png" />
                </div>
            ...
            <div className="flex flex-row justify-evenly text-3xl font-light my-10 leading-snug">
                <div className="flex flex-col items-center w-3/12 box-shadow br p-4 bg-pink-300">
                    ...
                    <div className="flex flex-row items-center w-1/2 justify-evenly mt-3">
                        <span>Alex</span>
                        <img className="h-16 rounded-full" src="https://www.opticalexpress.co.uk/media/1064/man-with-glasses-smiling-looking-into-distance.jpg" alt="male profile picture" />
                    </div>
                </div>
                <div className="flex flex-col items-center w-3/12 box-shadow br p-4 bg-pink-300">
                    <div className="text-center border-b border-gray-600 pb-3">
                    ...
                    <div className="flex flex-row items-center w-1/2 justify-evenly mt-3">
                        <span>Jerry</span>
                        <img className="h-16 rounded-full" src="https://cdn2.momjunction.com/wp-content/uploads/2021/02/What-Is-A-Sigma-Male-And-Their-Common-Personality-Trait-910x1024.jpg" alt="male profile picture" />
                    </div>
                </div>
                <div className="flex flex-col items-center w-3/12 box-shadow br p-4 bg-pink-300">
                    <div className="text-center border-b border-gray-600 pb-3">
                    ...
                    <div className="flex flex-row items-center w-1/2 justify-evenly mt-3">
                        <span>Sam</span>
                        <img className="h-16 rounded-full" src="https://i.pinimg.com/236x/37/cd/4a/37cd4ae9239b20dfd0f7f1e80194b344.jpg" alt="male profile picture" />
                    </div>
                </div>
            </div>
        </div>
